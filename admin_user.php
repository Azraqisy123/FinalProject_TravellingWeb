                                        ...
                                        while ($data = mysqli_fetch_array($user)) { ?>
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <?php
                                                        $imagePath = 'assets/images/user/' . $data["foto_user"];
                                                        if (!empty($data["foto_user"]) && file_exists($imagePath)) {
                                                            list($width, $height) = getimagesize($imagePath);
                                                            $newWidth = 80; // Atur lebar yang diinginkan
                                                            $newHeight = 80 * ($height / $width); // Sesuaikan tinggi berdasarkan rasio aspek

                                                            echo '<img src="' . $imagePath . '" alt="Foto user" class="img-thumbnail" width="' . $newWidth . '" height="' . $newHeight . '">';
                                                        } else {
                                                            echo 'No Pict';
                                                        }
                                                        ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="backend/proses_delete_user.php?id=<?php echo $data["id_user"] ?>" onclick="return confirm('Are you sure you want to delete this item?');">
