                                        ...
                                        while ($data = mysqli_fetch_array($kategori)) { ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $imagePath = 'assets/images/kategori/' . $data["foto_kategori"];
                                                        if (!empty($data["foto_kategori"]) && file_exists($imagePath)) {
                                                            list($width, $height) = getimagesize($imagePath);
                                                            $newWidth = 200; // Atur lebar yang diinginkan
                                                            $newHeight = 200 * ($height / $width); // Sesuaikan tinggi berdasarkan rasio aspek

                                                            echo '<img src="' . $imagePath . '" alt="Foto Kategori" class="img-thumbnail" width="' . $newWidth . '" height="' . $newHeight . '">';
                                                        } else {
                                                            echo 'No Pict';
                                                        }
                                                        ?>
                                                    ...
                                                    <td>
                                                        <a href="edit_categories.php?id=<?php echo $data["id_kategori"]; ?>">
                                                        ...
                                                        <a href="backend/proses_delete_categories.php?id=<?php echo $data["id_kategori"] ?>" onclick="return confirm('Are you sure you want to delete this item?');">
