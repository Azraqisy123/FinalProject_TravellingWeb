...
// pagination
$JumlahDataPerPage = 4;
$JumlahData = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM wisata JOIN kategori ON wisata.id_kategori = kategori.id_kategori WHERE kategori.nama_kategori = 'Alam'"));
...
$travels = mysqli_query($connection, "SELECT * FROM wisata JOIN kategori ON wisata.id_kategori = kategori.id_kategori WHERE kategori.nama_kategori = 'Alam' LIMIT $AwalData, $JumlahDataPerPage");
?>
        ...
        <div class="col-md-12">
          <div class="text-content">
            ...
            <div class="btn-group py-3">
              ...
              <a href="wisata_alam.php" class="btn btn-info">Wisata Alam</a>
