...
// pagination
$JumlahDataPerPage = 4;
$JumlahData = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM wisata JOIN kategori ON wisata.id_kategori = kategori.id_kategori WHERE kategori.nama_kategori = 'Bawah Laut'"));
...
$travels = mysqli_query($connection, "SELECT * FROM wisata JOIN kategori ON wisata.id_kategori = kategori.id_kategori WHERE kategori.nama_kategori = 'Bawah Laut' LIMIT $AwalData, $JumlahDataPerPage");
?>
